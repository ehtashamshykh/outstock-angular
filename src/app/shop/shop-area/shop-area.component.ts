...
export class ShopAreaComponent {
  ...
  constructor(
    ...
    // get all products
    if (this.productService.fetchProductCheck) this.productService.getProducts();
    ...
    this.route.queryParams.subscribe((params) => {
      ...
      this.productService.filterProducts().subscribe((response) => {
        ...
        // // seller Filter
        // if (this.seller){
        //   this.products = this.products.filter((p) => p.seller.toLowerCase() === this.seller);
        // }
  ...
  categoryProducts(data: IProduct[]){
    this.products = data
  }
}
